...
from features_utils import contest_metric
...
def ensemble(subms, score):
    ...
    out = open(SUBM_PATH + 'subm_countries.csv', 'w')
    ...
    s1 = pd.read_csv(SUBM_PATH + 'subm_countries.csv')
    ...
    s2.to_csv(SUBM_PATH + 'subm_{:.6f}_{}_{}.csv'.format(score, start_date, end_date), index=False)
